// Mengimpor model prodi untuk berinteraksi dengan koleksi fakultas di MongoDB
...
const getAllProdi = async (req, res) => {
    try {
        ...
        const prodi = await Prodi.find().populate("fakultas_id","nama singkatan");// Mengambil filed 'nama' dari Fakultas
